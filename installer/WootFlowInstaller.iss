...
[Icons]
Name: "{group}\WootFlow"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"; IconFilename: "{#MyAppIcon}"
Name: "{group}\Desinstalar WootFlow"; Filename: "{uninstallexe}"; IconFilename: "{#MyAppIcon}"
Name: "{autodesktop}\WootFlow"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"; Tasks: desktopicon; IconFilename: "{#MyAppIcon}"
